...
class HamstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hamster" do
    assert_difference('Hamster.count') do
      post hamsters_url, params: { hamster: { age: @hamster.age, name: @hamster.name } }, as: :json
    end
  ...
  test "should update hamster" do
    patch hamster_url(@hamster), params: { hamster: { age: @hamster.age, name: @hamster.name } }, as: :json
    assert_response 200
  end
